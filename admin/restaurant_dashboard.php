...
// Get pending orders count for this restaurant
...
// Get total menu items for this restaurant
...
// Get orders from the last 1 month for this restaurant
...
// // You can copy the rest of the HTML and dashboard UI from index.php
// include 'index.php'; // Or copy the HTML structure here and adjust as needed 
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Restaurant Dashboard - CodeToCuisine</title>
    <!-- Bootstrap & Icons -->
    ...
    <style>
        ...
        .dashboard-card { border-radius: 15px; box-shadow: 0 0.15rem 1.75rem 0 rgba(58, 59, 69, 0.15); transition: transform 0.2s; border: none; overflow: hidden; }
        .dashboard-card:hover { transform: translateY(-5px); }
        .card-icon { font-size: 2rem; opacity: 1; }
        .orders-card { border-left: 4px solid var(--primary-color); }
        .menu-card { border-left: 4px solid var(--success-color); }
        .pending-card { border-left: 4px solid var(--warning-color); }
        .today-card { border-left: 4px solid var(--info-color); }
        .quick-actions { background: white; border-radius: 15px; box-shadow: 0 0.15rem 1.75rem 0 rgba(58, 59, 69, 0.15); padding: 1.5rem; }
        .action-btn { padding: 1rem; border-radius: 10px; transition: all 0.3s; text-decoration: none; color: #5a5c69; }
        .action-btn:hover { background-color: #f8f9fc; transform: translateY(-2px); }
        .action-icon { font-size: 1.5rem; margin-bottom: 0.5rem; }
        .recent-orders { background: white; border-radius: 15px; box-shadow: 0 0.15rem 1.75rem 0 rgba(58, 59, 69, 0.15); }
        .order-item { border-bottom: 1px solid #e3e6f0; padding: 1rem; transition: background-color 0.2s; }
        .order-item:hover { background-color: #f8f9fc; }
        .status-badge { padding: 0.35rem 0.65rem; border-radius: 0.25rem; font-size: 0.75rem; font-weight: 600; }
        .status-pending { background-color: #f6c23e; color: white; }
        .status-completed { background-color: #1cc88a; color: white; }
        .status-info { background-color: #36b9cc; color: white; }
        .status-primary { background-color: #4e73df; color: white; }
...
<body>
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="h3 mb-0 text-gray-800">Restaurant Dashboard</h2>
                ...
                <div class="quick-actions">
                    ...
                    <div class="row">
                        <div class="col-md-2 col-6 mb-3">
                            <a href="#" id="generateQrLink" class="d-block text-center action-btn">
                                <i class="fas fa-qrcode action-icon text-dark"></i>
                        ...
                        <div class="col-md-2 col-6 mb-3">
                            <a href="profile.php" class="d-block text-center action-btn">
                                <i class="fas fa-user action-icon text-primary"></i>
    ...
    <script>
    document.getElementById('generateQrLink').addEventListener('click', function(e) {
        e.preventDefault();
        Swal.fire({
            icon: 'info',
            title: 'Coming Soon!',
            text: 'QR code generation will be available here soon.'
        });
    });
    </script>
</body>
